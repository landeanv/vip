...
sleep 2
clear
curl "https://raw.githubusercontent.com/landeanv/vip/master/menu/ssh-vpn.sh" | bash
sleep 2
wget https://raw.githubusercontent.com/landeanv/vip/master/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O demeling.sh https://raw.githubusercontent.com/landeanv/vip/master/demeling.sh && chmod +x demeling.sh && ./demeling.sh
...
sleep 2
clear
curl "https://raw.githubusercontent.com/landeanv/vip/master/Insshws/insshws.sh" | bash

#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/landeanv/vip/master/menu/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/landeanv/vip/master/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
curl "https://raw.githubusercontent.com/landeanv/vip/master/menu/insray.sh" | bash
sleep 1

curl "https://raw.githubusercontent.com/landeanv/vip/master/arca.sh" | bash
sleep 1
#install slowdns
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
wget -q -O slowdns.sh https://raw.githubusercontent.com/landeanv/vip/master/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
...
curl "https://raw.githubusercontent.com/landeanv/vip/master/ipsec/ipsec.sh" | bash

echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install OPENVPN             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"

wget "https://raw.githubusercontent.com/landeanv/vip/master/Insshws/vpn.sh" && bash vpn.sh && rm vpn.sh
clear
echo "Installing Bot Panel" | lolcat
echo "Siapkan Token bot dan ID telegram mu"
rm -rf bot.sh && wget https://raw.githubusercontent.com/landeanv/vip/master/botssh/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn

# pemberitahuan

USERID=6969517476
KEY="6634361412:AAEtKmyoQfZLYHCJwW4q3zAArUD2dS7gY44"
TIMEOUT="10"
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Autoscript Premium By @LandeanVPN ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ADIOS"
